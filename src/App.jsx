...
const App = () => {
  const [movies, setMovies] = useState([
    ...
    },
    {
      title: "Breaking Bad",
      description:
        "A struggling, frustrated high school chemistry teacher who becomes a crime lord in the local methamphetamine drug trade, driven to provide for his family financially after being diagnosed with inoperable lung cancer",
      posterURL:
